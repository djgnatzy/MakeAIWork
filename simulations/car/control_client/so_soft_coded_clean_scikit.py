...
# loadSonarModel = r'C:/MakeAIWork/simulations/car/control_client/tensorflow/sonar_model_a'
# loadSonarModel = r'C:/MakeAIWork/simulations/car/control_client/tensorflow/sonar_model_b'
# loadSonarModel = r'C:/MakeAIWork/simulations/car/control_client/tensorflow/sonar_model_c'

mpl = pickle.load(open('C:/MakeAIWork/simulations/car/control_client/scikitlearn/finalized_sonar_model.pkl', 'rb'))
...
class DrivingAgent:
    ...
    def sonarSweep (self):
        ...
        self.steeringAngle = float(steeringAngleModel (0))
        self.targetVelocity = pm.getTargetVelocity (self.steeringAngle)
